-- CreatorBook MVP schema (public browsing + booking + credits + reviews)
...
-- Profiles: public can read approved creators; users can read/update self
...
-- Posts: public can read; authed users can insert; owners can update/delete (for future edits)
...
-- Packages: public can read approved creators' packages; creators manage their own
...
create policy "packages_delete_creator_self"
on public.packages for delete
using (creator_id = auth.uid());

-- Bookings: client or attached creator can read; client can create; client/creator can update
...
-- reviews: anyone can read; client can insert after approved
